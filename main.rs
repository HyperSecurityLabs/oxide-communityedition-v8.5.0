...
fn print_banner() {
    ...
    println!("{}{}{}{}",
        ...
        tc(" ", ELITE_KALI));
    println!("{}", tc(&format!("╰{}╯", p), ELITE_KALI));
    println!("{}", tc("──────────────────────────────────────────────", ELITE_KALI));
    println!("{} {} [Kali-Linux]", tc("Author", ELITE_KALI), format!("\x1B[3m{}\x1B[0m", tc("khaninkali", ELITE_LAVENDER_B)));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("https://hypersecurity_offsec", ELITE_CYAN));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide --help", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --all", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --modules xss,sqli,lfi", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --fuzz --threads 100", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u targets.txt --multiattack --output json", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --duration 300 --verbose", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide --list-modules", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --modules agent --zeroday", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --insta --session", ELITE_LAVENDER));
    println!("{} \x1B[3m{}\x1B[0m", tc("↳", ELITE_KALI), tc("oxide -u https://example.com --modules all --output html", ELITE_LAVENDER));
    println!("{}", tc("──────────────────────────────────────────────", ELITE_KALI));
    println!();
}
