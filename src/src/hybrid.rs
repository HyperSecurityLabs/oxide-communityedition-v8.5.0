    ...
    pub async fn run_hybrid_scan(&mut self) -> Result<Vec<Finding>> {
        ...
        if !excluded.contains(&"fingerprint".to_string()) {
            ...
            if self.args.active {
                    ...
                    ($label:expr, $work:expr) => {{
                        ...
                        let _spinner_handle = tokio::spawn(async move {
                            ...
                            loop {
                                ...
                                idx += 1;
                                print!("\r\x1B[2K  \x1B[38;2;232;57;41m{}\x1B[0m  [38;2;139;129;195m{}...\x1B[0m", frame, lbl);
                        ...
                        print!("\r\x1B[2K");
                        println!("  [38;2;80;215;170m✓\x1B[0m  [38;2;46;169;223m{}\x1B[0m", $label);
                        result
                    }};
                }
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m[38;2;56;180;139mRECON[0m  [38;2;46;169;223m[{:02}:{:02}]\x1B[0m",
                ...
                if !cf_bypass.is_empty() {
                    println!("  [38;2;139;129;195mCFBYPASS\x1B[0m  Cloudflare origin bypass results:");
                    ...
                    for (header, server, body) in &cf_bypass {
                        let note = if !server.is_empty() && !server.to_lowercase().contains("cloudflare") {
                            format!(" [38;2;80;215;170morigin={}\x1B[0m", server)
                        } else if body.contains("cloudflare") || body.contains("cf-ray") {
                            " [38;2;46;169;223m(blocked by CF)\x1B[0m".to_string()
                        } else {
                            String::new()
                        };
                        if !server.is_empty() || !note.is_empty() {
                            println!("    [38;2;46;169;223m{:<30}\x1B[0m [38;2;139;129;195m{:<20}\x1B[0m{}", header, server, note);
                        }
                    }
        ...
        let _downloader = if self.args.download {
            ...
            println!(
                "  DOWNLOAD  Auto-download enabled → [38;2;46;169;223m{}\x1B[0m",
                dl.base_dir().display()
            );
            Some(dl)
        } else {
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"fuzz".to_string()) {
            if !excluded.contains(&"fuzz".to_string()) {
                ...
                println!("  {} {}",
                    tc("┌─", HISUI),
                    tc("FUZZING → Payload injection on all discovered URLs", KIKYO_B));
                    ...
                    tokio::spawn(async move {
                        ...
                        loop {
                            ...
                            let spin_bracketed = format!("{}[{}{}]{}",
                                tc("", TSUYUKUSA_B),
                                tc(cw, TSUYUKUSA_B), tc(ccw, KIKYO),
                                tc("", TSUYUKUSA_B));
                            ...
                            let blocks: String = (0..10).map(|i| {
                                ...
                                if mod_idx.saturating_add(1) >= threshold {
                                    format!("\x1B[38;2;80;215;170m▰\x1B[0m")
                                } else {
                            ...
                            let pip: String = mod_labels.iter().enumerate().map(|(i, l)| {
                                if i == mod_idx {
                                    format!("──▶ {}", format!("\x1B[38;2;80;215;170m{}\x1B[0m", l))
                                } else {
                            ...
                            let det_s = if det > 0 {
                                format!("\x1B[38;2;255;50;50;1m{} det\x1B[0m", det)
                            } else {
                                format!("\x1B[38;2;145;152;159m0 det\x1B[0m")
                            };
                            let err_s = if err > 0 {
                                format!("\x1B[38;2;255;180;50m{} err\x1B[0m", err)
                            } else {
                            ...
                            println!("\r\x1B[2K  {}  [{}]  {}  \x1B[38;2;46;169;223m{:>5.1}%\x1B[0m  \x1B[97m{:>4}/{}\x1B[0m  {}  {}  \x1B[38;2;145;152;159m{:>5.1}s\x1B[0m{}",
                                spin_bracketed,
                                bar,
                                pip,
                                pct * 100.0,
                            ...
                            println!("\r\x1B[2K  {} {} {}",
                                tc("\u{25B6}", KIKYO),
                                tc(&url_display, TSUYUKUSA),
                                border);

                            let status = format!("{} req  \u{00B7}  req/s:{:.0}", req, rate);
                            println!("\r\x1B[2K  {} {} {}",
                                tc("\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}", AI),
                                tc(&status, TSUYUKUSA),
                                border);
                ...
                println!("  {} Fuzzing complete: {} URLs, {} req, {} detections, {} errors  {}",
                    ...
                    tc(&total_detections.to_string(), HISUI_B),
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"sqli".to_string()) {
            if !excluded.contains(&"sqli".to_string()) {
                ...
                if !self.args.verbose {
                    ...
                    println!("  [38;2;56;180;139m[+]\x1B[0m[38;2;139;129;195m{}\x1B[0m[38;2;56;180;139m{}\x1B[0m  [38;2;139;129;195mTesting SQL injection on all URLs\x1B[0m", frame, "SQLi");
                    let s = ph_stop.clone();
                    ...
                    tokio::spawn(async move {
                        ...
                        loop {
                            ...
                            idx += 1;
                            print!("\x1B[{}A\r\x1B[2K  [38;2;56;180;139m[+]\x1B[0m[38;2;139;129;195m{}\x1B[0m[38;2;56;180;139m{}\x1B[0m  [38;2;139;129;195mTesting SQL injection on all URLs\x1B[0m\n", n, frame, "SQLi");
                ...
                for url in crawled_urls.iter().take(self.args.payload_limit) {
                    if !self.args.verbose {
                        println!("  [38;2;46;169;223m->\x1B[0m {}", url);
                    ...
                    if let Ok(findings) = sqli_scanner.comprehensive_scan(url, &params).await {
                        for finding in findings {
                            ...
                            if !self.args.verbose {
                                println!("  {} {}  [38;2;46;169;223m{}\x1B[0m", fmt_sev_label(&f.severity), f.title, url);
                                ph_lines.fetch_add(1, Ordering::Relaxed);
                            } else {
                                println!("  SQLi  {}  [38;2;46;169;223m{}\x1B[0m", f.title, url);
                            }
                            all_findings.push(f);
                        }
                    }
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m SQLi scan complete");
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"xss".to_string()) {
            if !excluded.contains(&"xss".to_string()) {
                ...
                if !self.args.verbose {
                    let frame = oxide::scanner::precision::bidir_braille(0);
                    println!("  [38;2;56;180;139m[+]\x1B[0m[38;2;139;129;195m{}\x1B[0m[38;2;56;180;139mXSS[0m  [38;2;139;129;195mTesting cross-site scripting on all URLs\x1B[0m", frame);
                    let s = ph_stop.clone();
                    let lb = ph_lines.clone();
                    tokio::spawn(async move {
                        let mut idx = 1usize;
                        loop {
                            ...
                            let frame = oxide::scanner::precision::bidir_braille(idx);
                            idx += 1;
                            print!("\x1B[{}A\r\x1B[2K  [38;2;56;180;139m[+]\x1B[0m[38;2;139;129;195m{}\x1B[0m[38;2;56;180;139mXSS[0m  [38;2;139;129;195mTesting cross-site scripting on all URLs\x1B[0m\n", n, frame);
                            if n > 1 { print!("\x1B[{}B", n - 1); }
                            let _ = std::io::Write::flush(&mut std::io::stdout());
                        }
                    });
                ...
                for url in crawled_urls.iter().take(self.args.payload_limit) {
                    ...
                    if let Ok(findings) = xss_scanner.comprehensive_scan(url, &params).await {
                        for finding in findings {
                            let f = self.convert_finding(&finding);
                            if verbose {
                                println!("  XSS   {}  [38;2;46;169;223m{}\x1B[0m", f.title, url);
                            }
                            all_findings.push(f);
                        }
                    }
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m XSS scan complete");
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"lfi".to_string()) {
            if !excluded.contains(&"lfi".to_string()) {
                ...
                if !self.args.verbose {
                    let frame = oxide::scanner::precision::bidir_braille(0);
                    println!("  [38;2;56;180;139m[+]\x1B[0m[38;2;139;129;195m{}\x1B[0m[38;2;56;180;139mLFI[0m  [38;2;139;129;195mTesting local file inclusion on all URLs\x1B[0m", frame);
                    let s = ph_stop.clone();
                    let lb = ph_lines.clone();
                    tokio::spawn(async move {
                        let mut idx = 1usize;
                        loop {
                            ...
                            let frame = oxide::scanner::precision::bidir_braille(idx);
                            idx += 1;
                            print!("\x1B[{}A\r\x1B[2K  [38;2;56;180;139m[+]\x1B[0m[38;2;139;129;195m{}\x1B[0m[38;2;56;180;139mLFI[0m  [38;2;139;129;195mTesting local file inclusion on all URLs\x1B[0m\n", n, frame);
                            if n > 1 { print!("\x1B[{}B", n - 1); }
                            let _ = std::io::Write::flush(&mut std::io::stdout());
                        }
                    });
                        ...
                        if let Ok(results) = lfi_scanner.exploit_lfi(url, &param).await {
                            for result in results {
                                if result.success {
                                    ...
                                    if verbose {
                                        println!("  LFI   {} via param `{}`  [38;2;46;169;223m{}\x1B[0m", result.technique, param, url);
                                    }
                                    all_findings.push(f);
                                }
                            }
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m LFI scan complete");
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"tls".to_string()) {
            if !excluded.contains(&"tls".to_string()) {
                ...
                for finding in tls_findings {
                    ...
                    println!("  {} {} [38;2;46;169;223m| {}\x1B[0m",
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m TLS assessment complete");
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"cors".to_string()) {
            if !excluded.contains(&"cors".to_string()) {
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m CORS assessment complete");
            }
        }
            ...
            if !excluded.contains(&"common".to_string()) {
                ...
                if let Ok(common_scanner) = CommonAppScanner::new(120) {
                    ...
                    for finding in common_findings {
                        ...
                        if verbose {
                            println!("  {} {} [38;2;46;169;223m{}\x1B[0m", fmt_sev_label(&sev), finding.title, finding.url);
                        }
                        all_findings.push(Finding::new(&finding.url, sev, &finding.title, &finding.description)
                            .with_evidence(&finding.evidence));
                    }
                }
                println!("  [38;2;56;180;139m[+]\x1B[0m Common app scan complete");
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"creds".to_string()) {
            if !excluded.contains(&"creds".to_string()) {
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m Credential scan complete");
            }
        }
            ...
            if !excluded.contains(&"filter".to_string()) {
                ...
                for url in &crawled_urls {
                    if let Ok(resp) = self.client.get(url).await {
                        ...
                        if verbose {
                            println!("  [38;2;46;169;223mScanning {} for secrets...\x1B[0m", url);
                        }
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m Filter complete: {} hits", filter_hits);
            }
        }
                ...
                match oxide::insta::InstaOSINT::new(120, false) {
                    Ok(insta) => {
                        match insta.full_scan(self.args.target_url()).await {
                            ...
                            Err(e) => println!("  \x1B[38;2;232;57;41m[!]\x1B[0m Instagram scan failed: {}", e),
                        }
                    }
                    Err(e) => println!("  \x1B[38;2;232;57;41m[!]\x1B[0m Failed to initialize Instagram scanner: {}", e),
                }
                println!("  [38;2;56;180;139m[+]\x1B[0m Instagram OSINT complete");
            }
        }
                ...
                match oxide::session_hijack::SessionHijackTester::new(120, self.args.insecure) {
                    Ok(tester) => {
                        match tester.full_test(self.args.target_url()).await {
                            ...
                            Err(e) => println!("  \x1B[38;2;232;57;41m[!]\x1B[0m Session test failed: {}", e),
                        }
                    }
                    Err(e) => println!("  \x1B[38;2;232;57;41m[!]\x1B[0m Failed to initialize session tester: {}", e),
                }
                println!("  [38;2;56;180;139m[+]\x1B[0m Session hijack assessment complete");
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"zero-day".to_string()) || self.args.zeroday {
            if !excluded.contains(&"zero-day".to_string()) {
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m ML detection complete: {} anomalies", ml_count);
            }
        }
        ...
        if modules.contains(&"all".to_string()) || modules.contains(&"agent".to_string()) {
            if !excluded.contains(&"agent".to_string()) {
                ...
                println!("  [38;2;56;180;139m[+]\x1B[0m Agent scan complete");
            }
        }
    ...
    async fn crawl_phase(&mut self) -> Result<Vec<String>> {
        ...
        for url in &urls {
            ...
            println!("  {} depth:0 forms:{} links:{}  {}",
                tc("[*]", HISUI_B),
                tc(&form_count.to_string(), TSUYUKUSA),
                tc(&link_count.to_string(), TSUYUKUSA),
                tc(&disp, KIKYO_B));
        }
                            ...
                            match label {
                                "SQLi" => {
                                    ...
                                    if let Some(finding) = self.analyzer.analyze(scan_result).await {
                                        ...
                                        println!("  {} {}  {}  [{}]",
                                            fmt_sev_label(&f.severity), f.title, tc(&fuzz_url, KIKYO_B), tc("sqli", FUJI));
                                        findings.push(f);
                                ...
                                "SQLi-D" => {
                                    ...
                                    if let Some(finding) = self.analyzer.analyze(scan_result).await {
                                        ...
                                        let _ = std::io::stdout().flush();
                                        println!("  {} {}  {}  [{}]",
                                            fmt_sev_label(&f.severity), f.title, tc(&fuzz_url, KIKYO_B), tc("sqli-d", SHU));
                                        findings.push(f);
                                        prog_det.fetch_add(1, Ordering::Relaxed);
                                        drop(_fw_lock);
                                    }
                                ...
                                "XSS" => {
                                    if Self::contains_xss(&response.body, &baseline_body, payload) {
                                        ...
                                        let _ = std::io::stdout().flush();
                                        println!("  {} {}  {}  [{}]",
                                            fmt_sev_label(&Severity::High), f.title, tc(&fuzz_url, KIKYO_B), tc("xss", FUJI));
                                        findings.push(f);
                                        drop(_fw_lock);
                                    }
                                }
                                "LFI" => {
                                    if Self::contains_lfi(&response.body, &baseline_body) {
                                        ...
                                        let _ = std::io::stdout().flush();
                                        println!("  {} {}  {}  [{}]",
                                            fmt_sev_label(&Severity::Critical), f.title, tc(&fuzz_url, KIKYO_B), tc("lfi", FUJI));
                                        findings.push(f);
                                        drop(_fw_lock);
                                    }
                                }
                                "CMDi" => {
                                    if Self::contains_cmdi(&response.body, &baseline_body) {
                                        ...
                                        let _ = std::io::stdout().flush();
                                        println!("  {} {}  {}  [{}]",
                                            fmt_sev_label(&Severity::Critical), f.title, tc(&fuzz_url, KIKYO_B), tc("cmdi", FUJI));
                                        findings.push(f);
                                        drop(_fw_lock);
                                    }
                                }
                                "NoSQL" => {
                                    ...
                                    if let Some(finding) = self.analyzer.analyze(scan_result).await {
                                        ...
                                        let _ = std::io::stdout().flush();
                                        println!("  {} {}  {}  [{}]",
                                            fmt_sev_label(&f.severity), f.title, tc(&fuzz_url, KIKYO_B), tc("nosql", TSUYUKUSA));
                                        findings.push(f);
                                        drop(_fw_lock);
                                    }
                                }
...
use crate::cli::display::{
    TSUYUKUSA, TSUYUKUSA_B,
    FUJI, KIKYO, KIKYO_B,
    HISUI, HISUI_B,
    AI, SHU, KURENAI, YAMABUKI,
};
...
fn fmt_status(status: u16) -> String {
    match status {
        200..=299 => tc(&status.to_string(), HISUI_B),
        300..=399 => tc(&status.to_string(), TSUYUKUSA),
        400..=499 => tc(&status.to_string(), SHU),
        500..=599 => tc(&status.to_string(), KURENAI),
...
fn fmt_sev_label(severity: &Severity) -> String {
    match severity {
        Severity::Critical => tc("CRITICAL  │", KURENAI),
        Severity::High     => tc("HIGH      │", SHU),
        Severity::Medium   => tc("MEDIUM    │", KIKYO_B),
