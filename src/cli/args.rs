...
#[command(name = "oxide")]
#[command(author, version = "8.6.9-community-edition", about = "OXIDE Community Edition — Open eXtensible Intelligence & Detection Engine", long_about = None)]
pub struct CliArgs {
    #[arg(short, long, help = "Target URL or URLs for security scanning.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: -u https://example.com\x1B[0m")]
    pub url: Vec<String>,
    ...
    #[arg(short, long, help = "Number of concurrent worker threads for scanning.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --threads 50\x1B[0m", default_value_t = 50)]
    pub threads: usize,
    ...
    #[arg(long, help = "Scan intensity level from 1 (gentle) to 100 (aggressive).
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --exploitation-level 75\x1B[0m", default_value_t = 75)]
    ...
    #[arg(long, help = "Maximum number of payloads to send per test case.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --payload-limit 100\x1B[0m", default_value_t = 100)]
    ...
    #[arg(short, long, help = "File path to save the scan report.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: -o report.json\x1B[0m")]
    ...
    #[arg(short, long, help = "Report output format selection.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: -f html\x1B[0m", default_value_t = String::from("json"))]
    pub format: String,
    ...
    #[arg(long, help = "Custom HTTP User-Agent header string.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --user-agent \"Mozilla/5.0 ...\"\x1B[0m")]
    ...
    #[arg(long, help = "HTTP Cookie header value to include with requests.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --cookie \"session=abc123\"\x1B[0m")]
    ...
    #[arg(long, help = "Custom HTTP headers to append to each request.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --header \"X-Custom: value\"\x1B[0m")]
    ...
    #[arg(short, long, help = "Enable detailed logging of scan progress and findings.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: -v\x1B[0m")]
    pub verbose: bool,
    ...
    #[arg(long, help = "Maximum requests per second rate limit.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --rate-limit 10\x1B[0m", default_value_t = 0)]
    pub rate_limit: u64,
    ...
    #[arg(long, help = "Automatically follow HTTP 3xx redirect responses.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --follow-redirects\x1B[0m")]
    pub follow_redirects: bool,

    #[arg(long, help = "Maximum number of consecutive redirects to follow.
                    Prevents infinite redirect loops during scanning.
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --max-redirects 5\x1B[0m", default_value_t = 10)]
    ...
    #[arg(long, help = "Disable SSL/TLS certificate validation.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --insecure\x1B[0m")]
    pub insecure: bool,
    ...
    #[arg(long, help = "HTTP proxy address for routing scan traffic.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --proxy http://127.0.0.1:8080\x1B[0m")]
    ...
    #[arg(long, help = "Modules to enable:
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --modules sqli,xss,lfi\x1B[0m")]
    ...
    #[arg(long, help = "Maximum link depth for URL crawling and discovery.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --crawl-depth 5\x1B[0m", default_value_t = 3)]
    pub crawl_depth: u8,
    ...
    #[arg(long, help = "Maximum number of unique pages to crawl and analyze.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --max-urls 500\x1B[0m", default_value_t = 100)]
    pub max_urls: usize,
    ...
    #[arg(long, help = "Reduce console output to warnings and findings only.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --silent-mode\x1B[0m")]
    ...
    #[arg(long, help = "Automatically download sensitive files discovered
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --download\x1B[0m")]
    pub download: bool,
    ...
    #[arg(long, help = "Comma-separated list of module names to skip.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --exclude engine,static\x1B[0m")]
    ...
    #[arg(long, help = "Enable experimental zero-day vulnerability detection.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --zeroday\x1B[0m")]
    pub zeroday: bool,
    ...
    #[arg(long, help = "Active TCP fingerprinting via raw packet injection.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --active\x1B[0m")]
    pub active: bool,
    ...
    #[arg(long, help = "Train the zero-day ML classifier by scanning with
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --train\x1B[0m")]
    pub train: bool,
    ...
    #[arg(long, help = "Enable the Instagram OSINT investigation module.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --insta\x1B[0m")]
    pub insta: bool,
    ...
    #[arg(long, help = "Enable session security analysis module.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --session\x1B[0m")]
    pub session: bool,
    ...
    #[arg(long, help = "Multi-target parallel scan mode for up to 3 URLs.
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --multiattack\x1B[0m")]
    ...
    #[arg(long, help = "Enable headless Chromium browser for JavaScript-heavy
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --headless\x1B[0m")]
    pub headless: bool,
    ...
    #[arg(long, help = "Resume a previously interrupted scan session from
                    ...
                    \x1B[38;2;56;180;139m\x1B[3mUsage: --resume\x1B[0m")]
    pub resume: bool,
}
